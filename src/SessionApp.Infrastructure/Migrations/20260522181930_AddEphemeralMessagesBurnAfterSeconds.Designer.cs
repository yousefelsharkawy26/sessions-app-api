...
namespace SessionApp.Infrastructure.Migrations
{
    ...
    [Migration("20260522181930_AddEphemeralMessagesBurnAfterSeconds")]
    partial class AddEphemeralMessagesBurnAfterSeconds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SessionApp.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SessionApp.Domain.Entities.Message", b =>
                {
                    ...
                    b.Property<int?>("BurnAfterSeconds")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SignedPrekeyIdUsed")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SessionApp.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SessionApp.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("SessionApp.Domain.Entities.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("SessionApp.Domain.Entities.PrekeyBundle", b =>
                {
                    b.HasOne("SessionApp.Domain.Entities.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("SessionApp.Domain.Entities.PrekeyBundle", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
